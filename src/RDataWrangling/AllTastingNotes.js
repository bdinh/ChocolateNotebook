export const TASTINGNOTES = [
    ...
    { label: 'Black pepper', value: 'blackpepper' }, 
    ...
    { label: 'Burnt sugar', value: 'burntsugar' }, 
    { label: 'Bread', value: 'bread' }, 
    { label: 'Toasted coconut', value: 'toastedcoconut' },
    { label: 'Apricot', value: 'apricot' }, 
    { label: 'Balsamic', value: 'balsamic' }, 
    { label: 'Ripe banana', value: 'ripebanana' }, 
    { label: 'Green banana', value: 'greenbanana' }, 
    { label: 'Dried fruit', value: 'driedfruit' }, 
    ...
    { label: 'Orange blossom', value: 'orangeblossom' }, 
    { label: 'Green tea', value: 'greentea' },
